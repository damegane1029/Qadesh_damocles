Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/6263ce75ac3e9064fa490b234f87c9f3"
{
	Properties
	{
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void applyFlipbook(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				float4 flipbookScaleOffset = float4(1,0.85,0,0);
				...
				if (!float(0))
				{
					if (float(10) != 0)
					{
						currentFrame = (_Time.y / (1 / float(10))) % float(50);
					}
				}
				else
				{
